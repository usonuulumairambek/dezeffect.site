...
function Cleaning() {
  return (
    <div className="cleaning">
      ...
      <div className="cleaning__container-sub">
        <p>
          В своей работе мы используем только профессиональное оборудование
          высокого качества, изготовленное ведущими производителями. Для чистки
          мебели, матрасов и ковров применяются специальные средства, которые не
          содержат в своем составе и не выделяют вредные для окружающей среды и
          здоровья человека материалы. Кроме того, они не вызывают аллергических
          реакций.
        </p>
      </div>
